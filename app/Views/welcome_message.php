...
<head>
    ...
    <!-- Page Title -->
    <title>Personal | Tokslaw</title>
    <!-- Favicon -->
    <link href="/assets/personal/img/favicon.ico" rel="icon">
    <!-- Bundle -->
    ...
    <!-- Style Sheet -->
    <link href="/assets/personal/css/page-animation.css" rel="stylesheet">
    <link href="/assets/personal/css/style.css" rel="stylesheet">
</head>
...
<header class="header-left">
    ...
    <a class="logo" href="index-personal.html">
        <h1 class="logo-text"><img src="/assets/personal/img/logo.png" alt="logo"></h1>
    </a>
                    ...
                    <div class="row align-items-lg-center">
                        ...
                        <div class="col-lg-7 order-lg-2">
                            <div class="slider-image">
                                <img src="/assets/personal/imggirl.png" alt="girl">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5 wow fadeInRight">
                            ...
                            <div class="heading-box">
                                <h2>Tokunbo<span class="main-color"></span> Lawal</h2>
                                <p>There are many variations of passages of Lorem Ipsum is at the available,
                                    but the majority have <span class="main-color">suffered</span> alteration some form,
                    ...
                    <div class="row align-items-lg-center dot-box">
                        ...
                        <div class="col-lg-6 order-lg-2">
                            <div class="heading-area pl-lg-4 p-0">
                                <h6 class="sub-title main-color">Basic info about componay</h6>
                                <h2 class="title">Digital Creator & Strategists</h2>
                                <p class="paragraph">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.
                                    <br><br>
                                    If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden the middle.</p>
                            </div>
                        </div>
                            ...
                            <div class="row d-flex align-items-lg-center">
                                <div class="col-md-6 order-lg-2 p-0">
                                    ...
                                    <div class="feature-item">
                                        ...
                                        <p>Simply dummy text of the print and typesetting industry lorem Ipsum has been standard.</p>
                                        <a href="javascript:void(0);" class="lni-arrow-right r-icon"></a>
                                    </div>
                                    <!-- Feature Item -->
                                    <div class="feature-item">
                    ...
                    <div class="row align-items-lg-center">
                        ...
                        <div class="col-lg-5 pr-lg-5">
                            <div class="heading-area">
                                ...
                                <h2 class="title">Our Services & Skills</h2>
                            </div>
                            <!-- Progress Bar -->
                        ...
                        <div class="col-lg-7">
                            <div class="services-about">
                                <img class="service-image" src="/assets/personal/imgservice-image.jpg" alt="image">
                                <div class="content">
                                    <p>Any desktop publishing packages and web page is a editors now use Lorem Ipsum as their default model text, and a search for their infancy.
                                        <br><br>
                                        any desktop publishing packages and web page editors now use.</p>

                                    <h5 class="mb-1">Harry Watson</h5>
                    ...
                    <div class="row align-items-lg-center">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div id="js-grid-mosaic-flat" class="cbp cbp-l-grid-mosaic-flat">
                                ...
                                <!-- Item -->
                                <div class="cbp-item">
                                    <a href="/assets/personal/img/port-1.jpg" class="cbp-caption cbp-lightbox">
                                        <div class="cbp-caption-defaultWrap">
                                            <img src="/assets/personal/img/port-1.jpg" alt="port-1">
                                        </div>
                                ...
                                <!-- Item -->
                                <div class="cbp-item">
                                    <a href="/assets/personal/img/port-2.jpg" class="cbp-caption cbp-lightbox">
                                        <div class="cbp-caption-defaultWrap">
                                            <img src="/assets/personal/img/port-2.jpg" alt="port-1">
                                        </div>
                                        <div class="cbp-caption-activeWrap">
                                            <i class="lni-arrow-right p-icon"></i>
                                            <div class="port-content">
                                ...
                                <!-- Item -->
                                <div class="cbp-item">
                                    <a href="/assets/personal/img/port-3.jpg" class="cbp-caption cbp-lightbox">
                                        <div class="cbp-caption-defaultWrap">
                                            <img src="/assets/personal/img/port-3.jpg" alt="port-1">
                                        </div>
                                        <div class="cbp-caption-activeWrap">
                                            <i class="lni-arrow-right p-icon"></i>
                                            <div class="port-content">
                                ...
                                <!-- Item -->
                                <div class="cbp-item">
                                    <a href="/assets/personal/img/port-4.jpg" class="cbp-caption cbp-lightbox">
                                        <div class="cbp-caption-defaultWrap">
                                            <img src="/assets/personal/img/port-4.jpg" alt="port-1">
                                        </div>
                                        <div class="cbp-caption-activeWrap">
                                            <i class="lni-arrow-right p-icon"></i>
                                            <div class="port-content">
                                ...
                                <!-- Item -->
                                <div class="cbp-item">
                                    <a href="/assets/personal/img/port-5.jpg" class="cbp-caption cbp-lightbox">
                                        <div class="cbp-caption-defaultWrap">
                                            <img src="/assets/personal/img/port-5.jpg" alt="port-1">
                                        </div>
                                        <div class="cbp-caption-activeWrap">
                                            <i class="lni-arrow-right p-icon"></i>
                                            <div class="port-content">
                ...
                <div class="container">
                        ...
                        <div class="col-lg-4 pr-lg-5 p-0">
                            <div class="heading-area">
                                ...
                                <p class="paragraph">There are many variations of passages of Lorem Ipsum available, but the majority.</p>
                            </div>
                        ...
                        <div class="col-lg-8">
                            <div id="owl-client" class="owl-carousel owl-theme">
                                ...
                                <div class="client-box">
                                        ...
                                        <p>There are many variations of passages of Lorem Ipsum availa  ble, but the majority There are many variations of passages of Lorem Ipsum availa  ble.</p>

                                        <div class="client-img">
                                            <img src="/assets/personal/imgavatar-1.png" alt="client">
                                        </div>
                                ...
                                <div class="client-box">
                                    ...
                                    <div class="client-img">
                                        <img src="/assets/personal/imgavatar-2.png" alt="client">
                                    </div>
                                ...
                                <div class="client-box">
                                    ...
                                    <div class="client-img">
                                        <img src="/assets/personal/imgavatar-3.png" alt="client">
                                    </div>
                        ...
                        <!--Partner Slider-->
                            ...
                            <div class="logo-item"> <img alt="client-logo" src="/assets/personal/img/client-1.png"></div>
                            <div class="logo-item"> <img alt="client-logo" src="/assets/personal/img/client-2.png"></div>
                            <div class="logo-item"> <img alt="client-logo" src="/assets/personal/img/client-3.png"></div>
                            <div class="logo-item"> <img alt="client-logo" src="/assets/personal/imgclient-4.png"></div>
                    ...
                    <div class="col-lg-6 pr-lg-5">
                        ...
                        <form class="contact-form" id="contact-form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input class="form-control" type="text" placeholder="Name" required="" id="your_name" name="userName">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <!--Button-->
                            <a href="javascript:void(0);" id="submit_btn" class="btn btn-large btn-rounded btn-green d-block mt-4 contact_btn"><i class="fa fa-spinner fa-spin mr-2 d-none" aria-hidden="true"></i>Send Message</a>
                               ...
                               <li class="w-100 mb-4">
                                ...
                                <li class="pr-2">
                                    ...
                                    <div class="content">
                                       ...
                                       <p><a href="mailto:email@website.co">email@website.com</a></p>
                                   </div>
                                </li>
                                <!--item-->
                                <li>
                                    ...
                                    <div class="content">
                                       <h6 class="main-color m-0">Address</h6>
                                       <p><a href="tel:002343474383">002 343474383</a></p>
                                   </div>
                                </li>
...
<script src="/assets/vendor/js/TweenMax.min.js"></script>
...
<script src="/assets/personal/js/map.js"></script>
<!-- custom script -->
<script src="/assets/personal/js/page-transition.js"></script>
<script src="/assets/vendor/js/contact_us.js"></script>
<script src="/assets/personal/js/script.js"></script>
